...
public class StoreController {
     ...
     */
    @ApiOperation(value = "대기 인원 관리 + 가게 현황 관리[가게 관리자]", notes = "대기 인원 명단과 가게 정보를 관리합니다")
     ...
     */
    @ApiOperation(value = "보류 인원 관리[가게 관리자]", notes = "보류 인원 명단을 관리합니다")
    @PreAuthorize("hasRole('ROLE_STORE_ADMIN')")
     ...
     * 가게 번호표 활성화
     */
    @ApiOperation(value = "가게 번호표 활성화[가게 관리자]", notes = "가게 번호표 뽑기 기능을 활성화시킵니다")
    @PreAuthorize("hasRole('ROLE_STORE_ADMIN')")
    @PostMapping("/status")
     ...
     * 가게 번호표 비활성화
     */
    @ApiOperation(value = "가게 번호표 비활성화[가게 관리자]", notes = "가게 번호표 뽑기 기능을 비활성화시킵니다")
    @PreAuthorize("hasRole('ROLE_STORE_ADMIN')")
    @PutMapping("/status")
